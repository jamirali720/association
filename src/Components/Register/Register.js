...
const Register = () => {
  const { registerUser, handleGoogleSignedIn, error, user, loading } =
    useAuth();
              ...
              <div className="card shadow-lg w-75 ms-5 bottom-items">
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                  ...
                  <div className="btn-container my-2 m-auto w-75">
                    <button
                      type="submit"
                      className="btn btn-primary form-control btn-submit"
                    >
                      Submit
                    </button>
                  </div>
                ...
                <div className="d-flex mx-auto">
                  {" "}
                  <div className="div1 mt-2 me-1"></div>{" "}
                  <small> OR Register with </small>
                  <div className="div2 mt-2 ms-1"></div>
                </div>
                <div className="social-container mt-2">
                  <button
                    className="mb-4 btn btn-primary"
                    onClick={() => handleGoogleSignedIn(navigate, location)}
                  >
                    <AiOutlineGoogle className="google-icon me-1 text-white fs-3" />{" "}
                    Login with Google account
                  </button>
                </div>
              </div>
            ) : (
              <Spinner className="text-center my-4 m-auto" animation="border" />
            )}
          </div>
        </div>
      </div>
